            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const ReadMoreText(
                    'The Nike Air Zoom Infinity Run Flyknit is designed to take your running experience to the next level. Crafted with precision, these shoes feature a cutting-edge Flyknit upper for a lightweight, breathable fit that adapts seamlessly to your foot. The responsive Zoom Air cushioning delivers an energetic, smooth ride, while the high-traction rubber outsole ensures stability and grip on any surface. With its bold, modern design and a snug, supportive feel, the Infinity Run Flyknit is perfect for runners of all levels, providing the comfort and performance you need to go further and faster. Whether you’re training or hitting the streets, experience the ultimate blend of style and innovation with these standout Nike shoes.',
                    trimLines: 2,
